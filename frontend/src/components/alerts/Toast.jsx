...
const Toast = ({ toast }) => {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="max-w-sm w-full bg-ios-surface/85 backdrop-blur-2xl border border-ios-separator/50 rounded-ios-control shadow-ios-card px-4 py-3 flex items-center gap-3 animate-ios-toast pointer-events-auto"
    >
